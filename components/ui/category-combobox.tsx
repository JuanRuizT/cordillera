    ...
    return (
      <div ref={containerRef} className="relative">
        <span
          ...
          title={disabled ? undefined : "Click to change category"}
          className={`block min-w-[80px] select-none ${disabled ? "" : "cursor-pointer hover:text-primary"} ${hasValue ? "" : "text-muted-foreground"}`}
        >
          {value || placeholder || "—"}
        </span>
        {!disabled && dropdown}
