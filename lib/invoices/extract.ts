    ...
    const { object } = await trackedGenerateObject(
      {
        ...
        system:
          ...
          "contractorName (nombre o razón social de quien cobra), contractorIdNumber (cédula o " +
          "NIT de quien cobra, solo dígitos). El concepto debe quedar en formato de oración normal " +
          "(mayúscula solo al inicio y en nombres propios) — nunca en mayúscula sostenida, aunque " +
          "el documento original lo tenga así. Si un dato no aparece claramente en el documento, " +
